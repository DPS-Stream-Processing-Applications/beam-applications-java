package at.ac.uibk.dps.streamprocessingapplications.train.genevents.logging;
...
//        try {
//            this.logStringPrefix = InetAddress.getLocalHost().getHostName() + "," +
// Thread.currentThread().getName() + "," + componentName;
      ...
      temp =
          File.createTempFile(
              o.getClass().getSimpleName()
                  ...
                  + "-"
                  + csvFileNameOut.split("\\/")[csvFileNameOut.split("\\/").length - 1]
                  + "-BoltPID-"
