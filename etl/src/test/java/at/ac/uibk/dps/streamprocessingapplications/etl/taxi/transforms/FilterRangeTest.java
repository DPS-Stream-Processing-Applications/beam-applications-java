...
public class FilterRangeTest {
    ...
    public void filterRange_withTripTimeInSecsLessThanOrEqual140_isSetToNull() {
        TaxiRide outOfRangeTripTime = new TaxiRide(null, null, null, new SenMLRecordDouble("", "", "", 140.0, null), null, null, null, null, null, null, null, null, null, null, null, null);
        // BUG: setting explicitly throws `NullPointerException`
        //outOfRangeTripTime.setTripTimeInSecs(140.0);
        TestStream<TaxiRide> createEvents = TestStream.create(SerializableCoder.of(TaxiRide.class))
                .addElements(outOfRangeTripTime)
                .advanceWatermarkToInfinity();

        PCollection<TaxiRide> actual = pipeline.apply(createEvents).apply(new FilterRange());
    ...
    public void filterRange_withTripTimeInSecs141_isUnchanged() {
        TaxiRide withinRangeTrimTime = new TaxiRide(null, null, null, new SenMLRecordDouble("", "", "", 141.0, null), null, null, null, null, null, null, null, null, null, null, null, null);
        // BUG: setting explicitly throws `NullPointerException`
        //outOfRangeTripTime.setTripTimeInSecs(140.0);
        TestStream<TaxiRide> createEvents = TestStream.create(SerializableCoder.of(TaxiRide.class))
