    ...
    public CompletableFuture<Void> apply(Context context, Message message) throws Throwable {
        ...
        if (Objects.equals(datatype, "FIT")) {
            ...
            for (FIT_data entity : result) {
                ...
                bf.append(entity.getAcc_chest_x())
                        .append(",")
                        ...
                        .append(",")
                        .append(entity.getEcg_lead_2())
                        .append(",")
                        .append(entity.getAcc_ankle_x())
                        .append(",")
                        .append(entity.getAcc_ankle_y())
                        .append(",")
                        .append(entity.getAcc_ankle_z())
                        .append(",")
                        .append(entity.getGyro_ankle_x())
                        .append(",")
                        .append(entity.getGyro_ankle_y())
                        .append(",")
                        .append(entity.getGyro_ankle_z())
                        .append(",")
                        .append(entity.getMagnetometer_ankle_x())
                        .append(",")
                        .append(entity.getMagnetometer_ankle_y())
                        .append(",")
                        .append(entity.getMagnetometer_ankle_z())
                        .append(",")
                        ...
                        .append(",")
                        .append(entity.getGyro_arm_x())
                        .append(",")
                        .append(entity.getGyro_arm_y())
                        .append(",")
                        .append(entity.getGyro_arm_z())
                        .append(",")
                        .append(entity.getMagnetometer_arm_x())
                        .append(",")
                        .append(entity.getMagnetometer_arm_y())
                        .append(",")
                        .append(entity.getMagnetometer_arm_z())
                        .append(",")
            ...
            for (SYS_City entity : result) {
                ...
                bf.append(entity.getLongitude())
                        .append(",")
                        .append(entity.getLatitude())
                        .append(",")
