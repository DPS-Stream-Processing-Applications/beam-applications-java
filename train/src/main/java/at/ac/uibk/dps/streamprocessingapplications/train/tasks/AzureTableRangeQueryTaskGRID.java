...
import at.ac.uibk.dps.streamprocessingapplications.train.utils.GridDataGenerator;
...
public class AzureTableRangeQueryTaskGRID extends AbstractTask {
  ...
  public static Iterable<GRID_data> getAzTableRangeByKeyTAXI(
    ...
    try {
      ...
      TableQuery<GRID_data> rangeQuery = TableQuery.from(GRID_data.class).where(combinedFilter);
