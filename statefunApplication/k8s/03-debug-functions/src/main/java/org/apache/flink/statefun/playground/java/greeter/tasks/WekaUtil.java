...
public class WekaUtil {
     ...
     * @return
     */
    public Instance prepareInstance(Instances instanceHeader, String[] testTuple, Logger l) {
     ...
     * @return
     */
    public Instances loadDatasetInstances(String fileName, Logger l) {
    ...
    public Instances loadDatasetInstances(Reader reader, Logger l) throws IOException {
