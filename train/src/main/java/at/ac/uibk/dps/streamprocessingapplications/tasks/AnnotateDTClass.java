...
public class AnnotateDTClass extends AbstractTask<String, String> {
    ...
    // 03:57:00,2013-01-14
    // 04:23:00,200,10,-73.953178,40.776016,-73.779190,40.645145,CRD,52.00,0.00,0.50,13.00,4.80,70.30";
    ...
    public void setup(Logger l_, Properties p_) {
        ...
        synchronized (SETUP_LOCK) {
            if (!doneSetup) {
                // Check usefield
                useMsgField =
                        Integer.parseInt(p_.getProperty("ANNOTATE.ANNOTATE_MSG_USE_FIELD", "0"));
                doneSetup = true;
            }
        }
    }
    ...
    protected Float doTaskLogic(Map<String, String> map) {
        ...
        if (l.isInfoEnabled()) l.info("percentile results: {}", percentile.evaluate(100));

        TreeMap<Double, String> annotationMap = new TreeMap<>();
        ...
        if (l.isInfoEnabled()) l.info("annotated data is {}", annotatedData);
