...
import at.ac.uibk.dps.streamprocessingapplications.train.utils.TaxiDataGenerator;
...
public class AzureTableRangeQueryTaskTAXI extends AbstractTask {
  ...
  public static Iterable<Taxi_Trip> getAzTableRangeByKeyTAXI(
    ...
    try {
      ...
      TableQuery<Taxi_Trip> rangeQuery = TableQuery.from(Taxi_Trip.class).where(combinedFilter);
